...
export type ButtonVariant = 'default' | 'primary' | 'secondary' | 'ghost' | 'link' | 'destructive' | 'outline';
export type ButtonSize = 'sm' | 'md' | 'lg';

const variantStyles: Record<ButtonVariant, string> = {
  default: 'bg-white text-slate-900 border border-slate-200 hover:bg-slate-100 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-800 dark:hover:bg-slate-800',
